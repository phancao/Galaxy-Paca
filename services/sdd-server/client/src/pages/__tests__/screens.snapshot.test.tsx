  ...
  return {
    ...
    api: {
      ...
      sdd: {
        ...
        specVersions: r({ docs: {}, count: 0 }),
        flags: r({ sharedCore: [], unapprovedL3: [] }),
        specSyncStatus: r({ configured: false, hasToken: false }),
        session: r({ session_id: "sess-1", phases: [], activity: [], gates: [] }),
        git: r({ session_id: "sess-1", cwd: "/test", git: { isRepo: false } }),
        setGate: r({ ok: true, gate: {} }),
        specSync: r({ configured: false, fetched: 0, upserted: 0 }),
      },
    },
  };
});
